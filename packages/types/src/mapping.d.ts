 ...
 */
export type ScaleType = 'C_MAJOR' | 'C_MINOR' | 'D_MAJOR' | 'E_MINOR' | 'A_MINOR' | 'A_SHARP_MINOR' | 'G_MAJOR' | 'C_PENTATONIC' | 'A_MINOR_PENTATONIC' | 'C_BLUES' | 'D_DORIAN' | 'A_DORIAN' | 'C_MIXOLYDIAN' | 'E_PHRYGIAN';
/**
